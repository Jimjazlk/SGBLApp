        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanPenaltyUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Book_Genre_PrimaryGenreId",
                        column: x => x.PrimaryGenreId,
                        principalTable: "Genre",
                        principalColumn: "GenreId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Book_Genre_SecondaryGenreId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookFeedbacks_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendationFeedbackPositive = table.Column<int>(type: "int", nullable: false),
                    RecommendationFeedbackNegative = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPopularity", x => x.BookId);
                    table.ForeignKey(
                        name: "FK_BookPopularity_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notification_Loan_LoanId",
                        column: x => x.LoanId,
                        principalTable: "Loan",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Book_PrimaryGenreId",
                table: "Book",
                column: "PrimaryGenreId");

            migrationBuilder.CreateIndex(
                name: "IX_Book_SecondaryGenreId",
                table: "Book",
