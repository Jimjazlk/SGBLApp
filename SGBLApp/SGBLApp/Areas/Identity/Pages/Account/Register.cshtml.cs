...
namespace SGBLApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Libraries = _libraryService.GetAll()
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirma tu email",
                        $"<h2>Confirmacion de email</h2> <br /> Porfavor confirma tu cuenta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>click aqui</a>!");
